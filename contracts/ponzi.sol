...
/* Ponzi Token with Bancor like trading.
 * keeps 80 % reserve
 * 5 % of buying amount is paid to stake holders in ethers.
 */
...
contract PonziToken {
	...
	function reserve() public constant returns (uint256 amount) {
		return balance()
			- ((uint256) ((int256) (earningsPerShare * totalSupply) - totalPayouts + PRECISION - 1) / PRECISION);
	}
	...
	function buy() internal {
		...
		Transfer(address(this), sender, numTokens);
	}
